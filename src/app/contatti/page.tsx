...
export default function ContactSection() {
  ...
  return (
    <>
      <section className="flex-grow max-w-7xl mx-auto px-4 py-10 sm:px-6 sm:py-16 mt-16">
        <h1 className="text-3xl text-center sm:text-4xl lg:text-5xl font-bold mb-12 text-black ">
          Contatti
        </h1>
